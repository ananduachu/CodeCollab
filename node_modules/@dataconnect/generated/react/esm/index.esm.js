import { insertUserRef, getWorkspaceRef, createFileRef, listFilesRef, connectorConfig } from '../../esm/index.esm.js';
...
export function useGetWorkspace(dcOrOptions, options) {
...
export function useListFiles(dcOrVars, varsOrOptions, options) {
